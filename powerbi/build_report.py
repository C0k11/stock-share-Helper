...
def visual(name: str, vtype: str, x: float, y: float, w: float, h: float,
           ...
           no_totals: bool = False, filters: list[dict] | None = None) -> dict:
...
def market_page() -> dict:
    visuals = [
        visual("mo_slicer_date", "slicer", 20, 20, 300, 70,
               {"Values": [d_date()]}),
        visual("mo_slicer_symbol", "slicer", 340, 20, 220, 70,
               {"Values": [s_sym()]}),
        ...
        visual("mo_table", "tableEx", 20, 520, 1240, 180,
               {"Values": [
                   ...
                   mea("Last Close"),
                   mea("Daily Return"),
                   mea("Rolling Vol 20D (Ann)"),
                   mea("Pct From 52W High (Latest)"),
                   col("s", "price_bars", "dim_symbol"),
               ]},
               orderby=col("s", "symbol", "dim_symbol"),
               title="Symbol snapshot", no_totals=True),
    ]
...
def signals_page() -> dict:
    visuals = [
        ...
        visual("sig_sub_avg", "clusteredColumnChart", 660, 390, 600, 160,
        ...
        visual("sig_combo", "lineClusteredColumnComboChart", 20, 560, 1240, 140,
...
def backtest_page() -> dict:
    ...
    visuals += [
        visual("bt_equity_line", "lineChart", 20, 130, 1240, 280,
        ...
        visual("bt_dd_area", "areaChart", 20, 420, 1240, 150,
               {"Category": [col("e", "date", "fact_backtest_equity")], "Y": [mea("Drawdown")]},
               title="Drawdown"),
        visual("bt_table", "tableEx", 20, 580, 1240, 120,
               {"Values": [
                   col("r", "run_id", "fact_backtest_results"),
                   col("r", "strategy", "fact_backtest_results"),
                   col("r", "symbol", "fact_backtest_results"),
                   col("r", "fill_timing", "fact_backtest_results"),
                   mea("Total Return"), mea("CAGR"), mea("Annual Volatility"), mea("Sharpe"),
                   mea("Max Drawdown"), mea("Win Rate"),
                   col("r", "trading_days", "fact_backtest_results"),
                   col("r", "start_date", "fact_backtest_results"),
                   col("r", "end_date", "fact_backtest_results"),
               ]},
